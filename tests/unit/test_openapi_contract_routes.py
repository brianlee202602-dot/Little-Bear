...
EXPECTED_CONTRACT_ONLY_OPERATIONS = {
    ("/internal/v1/admin/documents/{doc_id}", "DELETE"),
    ("/internal/v1/admin/documents/{doc_id}", "GET"),
    ("/internal/v1/admin/documents/{doc_id}", "PATCH"),
    ...
    ("/internal/v1/admin/folders/{folder_id}", "DELETE"),
    ("/internal/v1/admin/folders/{folder_id}", "GET"),
    ("/internal/v1/admin/folders/{folder_id}", "PATCH"),
    ("/internal/v1/admin/import-jobs", "GET"),
    ("/internal/v1/admin/import-jobs/{job_id}", "GET"),
    ("/internal/v1/admin/knowledge-bases", "POST"),
    ("/internal/v1/admin/knowledge-bases/{kb_id}", "DELETE"),
    ("/internal/v1/admin/knowledge-bases/{kb_id}", "GET"),
    ("/internal/v1/admin/knowledge-bases/{kb_id}", "PATCH"),
    ("/internal/v1/admin/knowledge-bases/{kb_id}/documents", "GET"),
    ("/internal/v1/admin/knowledge-bases/{kb_id}/folders", "GET"),
    ("/internal/v1/admin/knowledge-bases/{kb_id}/folders", "POST"),
